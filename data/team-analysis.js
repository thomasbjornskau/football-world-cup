...
window.WC_ANALYSIS = {
  "disclaimer": "Open tactical data is limited and squads change quickly. These summaries are curated from publicly available analysis and recent match reports, and should be read as indicative rather than definitive.",
  "teams": [
    {
      "teamId": "morocco",
      ...
      "strengths": [
        ...
        "Collective discipline and intensity"
      ],
      "weaknesses": [
        "Can struggle to create against deep blocks",
        "May become passive when protecting a lead"
      ],
      "keyPlayers": [
        "Achraf Hakimi",
        "Sofyan Amrabat",
    ...
    },
    {
      ...
      "strengths": [
        "Midfield control and pressing coordination",
        "Tournament experience and composure",
        "Set-piece organisation"
      ],
      "weaknesses": [
        "An ageing core in key positions",
        "A recurring reliance on individual moments to unlock deep defences"
      ],
      "keyPlayers": [
        "Lionel Messi",
        "Enzo Fernández",
    ...
    },
    {
      ...
      "strengths": [
        "Transition speed and individual quality",
        "Depth across the squad",
        "Big-tournament pedigree"
      ],
      "weaknesses": [
        "Can drop too deep and invite pressure",
        "Build-up can look laboured against an organised press"
      ],
      "keyPlayers": [
        "Kylian Mbappé",
        "Aurélien Tchouaméni",
    ...
    },
    {
      ...
      "strengths": [
        "Individual quality in the front line",
        "Pace and unpredictability in wide areas"
      ],
      "weaknesses": [
        "A recurring pattern is instability from frequent coaching changes",
        "Balance between attacking talents is still being worked out"
      ],
      "keyPlayers": [
        "Vinícius Júnior",
        "Raphinha",
    ...
    },
    {
      ...
      "strengths": [
        ...
        "Set pieces",
        "A settled, experienced spine"
      ],
      "weaknesses": [
        "One possible weakness is creativity against very deep blocks",
        "A history of conceding momentum in knockout ties"
      ],
      "keyPlayers": [
        "Harry Kane",
        "Jude Bellingham",
    ...
    },
    {
      ...
      "strengths": [
        "Pressing intensity and discipline",
        "Transitions through wide areas",
        "Squad depth from players in top European leagues"
      ],
      "weaknesses": [
        "Chance conversion has been a recurring issue",
        "Sustained possession against deep blocks"
      ],
      "keyPlayers": [
        "Kaoru Mitoma",
        "Takefusa Kubo",
    ...
    },
    {
      ...
      "strengths": [
        "Athleticism and pressing energy",
        "Home advantage and crowd momentum",
        "A core entering its prime"
      ],
      "weaknesses": [
        "Chance creation in settled possession",
        "Limited experience of deep tournament runs"
      ],
      "keyPlayers": [
        "Christian Pulisic",
        "Weston McKennie",
    ...
    },
    {
      ...
      "strengths": [
        "Elite finishing through Haaland",
        "Clarity of game plan",
        "Set pieces and transitions"
      ],
      "weaknesses": [
        "One possible weakness is defending wide areas against quick wingers",
        "Depth beyond the first-choice spine"
      ],
      "keyPlayers": [
        "Erling Haaland",
        "Martin Ødegaard",
